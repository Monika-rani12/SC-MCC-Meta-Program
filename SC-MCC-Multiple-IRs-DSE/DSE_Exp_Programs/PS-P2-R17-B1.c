...
int kappa;
	...
	void calculate_outputm26(int);
	 ...
	 int a65,a46,a107,a110,a22,a13,a140,a58,cf,a42;
...
klee_make_symbolic(&a65, sizeof(int ), "a65");  
klee_make_symbolic(&a46, sizeof(int ), "a46");  
klee_make_symbolic(&a107, sizeof(int ), "a107");  
klee_make_symbolic(&a110, sizeof(int ), "a110");  
klee_make_symbolic(&a22, sizeof(int ), "a22");  
klee_make_symbolic(&a13, sizeof(int ), "a13");  
klee_make_symbolic(&a140, sizeof(int ), "a140");   
klee_make_symbolic(&a58, sizeof(int ), "a58"); 
klee_make_symbolic(&cf, sizeof(int ), "cf"); 
klee_make_symbolic(&a42, sizeof(int ), "a42"); 
printf("%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n%d\n",a65,a46,a107,a110,a22,a13,a140,a58,cf,a42);	
        // operate eca engine
printf("POINT: 145\n");
