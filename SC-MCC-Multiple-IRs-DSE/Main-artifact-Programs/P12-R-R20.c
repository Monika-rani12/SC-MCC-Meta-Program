...
#include <stdlib.h>
 ...
 void calculate_outputm121(int input) {
	...
	if((a1747937390 - 20) < a1747937390){
	a1747937390  -=  6 ;}
	 else{	
	a1747937390  -=  0;}
	if((a1917006927 - 20) < a1917006927){
	a1917006927  -=  3 ;}
	 else{	
	a1917006927  -=  0;}
    	cf = 0;
...
kappa = 0;
   ...
   int symb;   
    for (int FLAG=0;FLAG<BOUND;FLAG++)
    {
        ...
        // operate eca engine
          if((symb != 5) && (symb != 8) && (symb != 6) && (symb != 9) && (symb != 3)){
          if((symb != 4) && (symb != 1) && (symb != 2) && (symb != 10) && (symb != 7)){
          return -2;
          }
          }
