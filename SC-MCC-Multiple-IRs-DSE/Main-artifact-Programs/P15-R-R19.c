...
#include <stdlib.h>
 ...
 void calculate_outputm34(int input) {
	...
	if((a1711183540 - 20) < a1711183540){
	a1711183540  -=  2 ;}
	 else{	
	a1711183540  -=  0;}
	if((a1233331030 + 20) > a1233331030){
	a1233331030  +=  2 ;}
	 else{	
	a1233331030  +=  0;}
	if((a170107731 + 20) > a170107731){
	a170107731  +=  2 ;}
	 else{	
	a170107731  +=  0;}
    	cf = 0;
 ...
 void calculate_outputm38(int input) {
	...
	if((a1451139861 - 20) < a1451139861){
	a1451139861  -=  2 ;}
	 else{	
	a1451139861  -=  0;}
	if((a419312954 + 20) > a419312954){
	a419312954  +=  1 ;}
	 else{	
	a419312954  +=  0;}
    	cf = 0;
 ...
 void calculate_outputm208(int input) {
	...
	if((a1835250293 - 20) < a1835250293){
	a1835250293  -=  2 ;}
	 else{	
	a1835250293  -=  0;}
	if((a1329406336 - 20) < a1329406336){
	a1329406336  -=  6 ;}
	 else{	
	a1329406336  -=  0;}
    	cf = 0;
...
kappa = 0;
   ...
   int symb;   
    for (int FLAG=0;FLAG<BOUND;FLAG++)
    {
        ...
        // operate eca engine
       if((symb != 4) && (symb != 5) && (symb != 2) && (symb != 14) && (symb != 8)){
                if((symb != 10) && (symb != 3) && (symb != 6) && (symb != 7) && (symb != 9)){
                if((symb != 12) && (symb != 13) && (symb != 11) && (symb != 15) && (symb != 1)){
                return -2;
                }
                }
         }
