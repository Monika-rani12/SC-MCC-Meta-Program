...
cp -r result-$BENCHMARK-TX-$toolValue/$BENCHMARK-KTEST-TX/*.* ../KLEEMA/klee-out-0/
...
mv result-$BENCHMARK-TX-$toolValue ../Results/$BENCHMARK-Results/result-$BENCHMARK-mode2
cd ..
cd KLEEMA

./KLEEMA.sh $BENCHMARK $toolValue
mv $BENCHMARK-RESULTS-$toolValue ../Results/$BENCHMARK-Results/result-$BENCHMARK-mode2/
cd ..
#rm -r $BENCHMARK.c
